    ...
    <Stack gap="md" p="md" style={{
      ...
      {!isClosed && (
        <Paper withBorder radius="md" p="sm">
          ...
          />
          <input ref={fileInputRef} type="file" multiple style={{ display: 'none' }} onChange={handleFileSelect} accept="image/jpeg,image/png,image/gif,image/webp,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,text/plain,application/zip,application/x-zip-compressed,application/x-apple-diskimage,application/x-newton-compatible-pkg,application/vnd.microsoft.portable-executable,application/x-msdownload,application/x-msi,application/vnd.debian.binary-package,application/x-rpm,application/x-executable,application/vnd.android.package-archive,.jpg,.jpeg,.png,.gif,.webp,.pdf,.doc,.docx,.txt,.zip,.dmg,.pkg,.exe,.msi,.deb,.rpm,.AppImage,.apk" />
